...
The main goal of _fabricstore_ is to be integrated into Indigo framework suite. To use the Indigo fabric storage, please install `strat` from #stratumn/sdk to generate a new project choosing the store _Indigo's Hyperledger Fabric Node_.
